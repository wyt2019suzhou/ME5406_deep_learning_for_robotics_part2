...
def common_arg_parser():
    ...
    parser.add_argument('--p_coef', help='policy loss discount factor', default=1000.0)
    parser.add_argument('--human_ent_coef', help='human entropy discount factor', default=0.001)
    parser.add_argument('--human_vf_coef', help='human value loss discount factor', default=0.5)
    parser.add_argument('--human_p_coef', help='human policy loss discount factor', default=1000.0)

    # run parameters
    parser.add_argument('--nsteps', help='each environment act step', default=500)
    parser.add_argument('--nminibatches', help='number of minibatch in one train batch', default=15)
    parser.add_argument('--noptepochs', help='number of reuse experience ', default=10)
    parser.add_argument('--num_env', help='Number of environment copies being run in parallel', default=15, type=int)
